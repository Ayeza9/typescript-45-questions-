...
console.log(`hellow ${personName1} would you like to learn some python today ?`);
//Q NO 3
//Name Cases: Store a person’s name in a variable, and then print that person’s name in lowercase,
//uppercase, and titlecase.
//lower Case
let personName2 = "Maryam";
...
let message1 = `${famous_person} onse said,"${quote}"`;
console.log(message1);
//Q NO 6
// Stripping Names: Store a person’s name, and include some whitespace charactersat the beginning and end 
//of the names.
...
let students1 = ["haya", "maryam", "ayzal", "hamdan",];
...
let students = ["haya", "daniyal", "hamza", "ayzal", "rizwana"];
let message = `Good Morning I hope You Are Enjoying alot:`;
...
let favoriteTransportation = ["motorcycle", "car", "train", "bus",];
...
let guestList2 = ["zobia", "aiza", "zearish"];
for (let i = 0; i < guestList2.length; i++) {
    console.log(`hello Dear ` + guestList2[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!`);
}
let abscentPerson1 = "aiza";
let newGuest1 = "khadija";
guestList2[1] = newGuest1;
for (let i = 0; i < guestList2.length; i++) {
    console.log(`hello Dear ` + guestList2[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!`);
}
console.log(`Miss.${abscentPerson1} will not come tomorrow dinnr.`);
//Q NO 16
...
let guestList3 = ["zobia", "aiza", "zearish"];
//for(let i=0; i<guestList.length; i++){
// console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
//}
let abscentPerson2 = "aiza";
let newGuest2 = "khadija";
guestList3[1] = newGuest2;
for (let i = 0; i < guestList3.length; i++) {
    console.log(`hello Dear ` + guestList3[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!`);
}
guestList3.unshift("zonia", "rabiya", "rida");
for (let i = 0; i < guestList3.length; i++) {
...
let guest_List = ["zobia", "aiza", "zearish"];
//for(let i=0; i<guestList.length; i++){
// console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
//}
let abscentPerson = "aiza";
let newGuest = "khadija";
guest_List[1] = newGuest;
//for(let i=0; i<guestList.length; i++){
//   console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
//}
guest_List.unshift("zonia", "rabiya", "rida");
//for(let i=0; i<guestList.length; i++){
//console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.we found a big table so we decide to invite 3 more guest\n\n Thank You!\n` )
//}
...
let places = ["Saudia Arabia", "China", "Skardo", "kyoto", "Turkey"];
...
let guestList = ["zobia", "aiza", "zearish", "haya", "maryam"];
//for(let i=0; i<guestList.length; i++){
// console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
//}
...
let pakistanProvinceLanguages = ["pashto", "balochi", "sindhi", "punjabi"];
...
let shoppingArray = ["dresses", " jewellery", "shoes", 4, 16, 12];
...
let favouriteFruits = ["strawberry", "mango", "dragon Fruit"];
...
const userName = ['Admin', 'Ali Phull', 'Muhammad', 'Kamran', 'Muhammad Bhuran', 'Muhammad Ali'];
function greetUsers() {
...
let user = ["maryam", "haya", "daniyal", " hadi", "admin"];
if (user.length === 0) {
...
let currentUsers = ["Maryam", "haya", "Hamdan", "Maham", "Hadi"];
let newUsers = ["Rabiya", "hamna", "Haya", "Anusha", "Hamdan"];
...
let favoritePizza = ["fajita Pizza", "cheeze Pizza", "chickenTikka Pizza"];
...
//define an array of magician names
let magicians_names1 = ["harry houdini", "criss angel", "derren brown"];
...
let myCar = createCar("toyota", "corolla", ["color", "black"], ["optional features", "sunroof "]);
console.log(myCar);
