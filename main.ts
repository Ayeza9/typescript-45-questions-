...
let students1: string[] = ["haya", "maryam","ayzal", "hamdan",];
...
let guestList1: string[] = ["zobia", "aiza","zearish"];
...
let guestList2: string[] = ["zobia", "aiza","zearish"];
for(let i=0; i<guestList2.length; i++){
    console.log(`hello Dear ` + guestList2[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
}
 
let abscentPerson1: string = "aiza";
let newGuest1: string = "khadija";
...
let guestList3: string[] = ["zobia", "aiza","zearish"];
//for(let i=0; i<guestList.length; i++){
    // console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
//}
 
let abscentPerson2: string = "aiza";
let newGuest2: string = "khadija";
...
let guest_List: string[] = ["zobia", "aiza","zearish"];
//for(let i=0; i<guestList.length; i++){
    // console.log(`hello Dear ` + guestList[i] + `, \n\n you are invited to dinner on Tomorrow Please Join Us.\n\n Thank You!` )
//}
